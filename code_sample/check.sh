...
for file in "${office_files[@]}"; do
    ...
    call_api "${file}" "path" "pdf"
    call_api "${file}" "path" "html"

    # URL parameter tests
    call_api "${BASE_URL}/aview/files/${file}" "url" "pdf"
    call_api "${BASE_URL}/aview/files/${file}" "url" "html"
done
...
call_api "${first_office_file}" "path" "pdf"
call_api "${first_office_file}" "path" "html"
call_api "${BASE_URL}/aview/files/${first_office_file}" "url" "pdf"
call_api "${BASE_URL}/aview/files/${first_office_file}" "url" "html"
